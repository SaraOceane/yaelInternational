                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="dashboard.html" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Se connecter via Google
                                        </a>
                                        <a href="dashboard.html" class="btn btn-facebook btn-user btn-block">
                                            <i class="fab fa-facebook-f fa-fw"></i> Se connercter via Facebook
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="register.html">créer un votre Entreprise!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
